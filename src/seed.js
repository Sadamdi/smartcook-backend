...
const ingredients = [
  { name: "Ayam utuh", category: "protein", sub_category: "Protein Hewani", unit: "gram", common_quantity: 500 },
  { name: "Dada ayam", category: "protein", sub_category: "Protein Hewani", unit: "gram", common_quantity: 250 },
  { name: "Paha ayam", category: "protein", sub_category: "Protein Hewani", unit: "gram", common_quantity: 250 },
  { name: "Sayap ayam", category: "protein", sub_category: "Protein Hewani", unit: "gram", common_quantity: 200 },
  { name: "Daging bebek", category: "protein", sub_category: "Protein Hewani", unit: "gram", common_quantity: 300 },
  { name: "Daging sapi", category: "protein", sub_category: "Protein Hewani", unit: "gram", common_quantity: 250 },
  { name: "Daging giling", category: "protein", sub_category: "Protein Hewani", unit: "gram", common_quantity: 250 },
  { name: "Iga sapi", category: "protein", sub_category: "Protein Hewani", unit: "gram", common_quantity: 500 },
  { name: "Daging kambing", category: "protein", sub_category: "Protein Hewani", unit: "gram", common_quantity: 250 },
  { name: "Daging domba", category: "protein", sub_category: "Protein Hewani", unit: "gram", common_quantity: 250 },
  { name: "Telur ayam", category: "protein", sub_category: "Protein Hewani", unit: "butir", common_quantity: 6 },
  { name: "Telur bebek", category: "protein", sub_category: "Protein Hewani", unit: "butir", common_quantity: 6 },
  { name: "Telur Puyuh", category: "protein", sub_category: "Protein Hewani", unit: "butir", common_quantity: 10 },
  { name: "Sosis", category: "protein", sub_category: "Protein Hewani", unit: "gram", common_quantity: 200 },
  { name: "Bakso", category: "protein", sub_category: "Protein Hewani", unit: "gram", common_quantity: 200 },
  { name: "Nugget", category: "protein", sub_category: "Protein Hewani", unit: "gram", common_quantity: 200 },
  { name: "Kornet", category: "protein", sub_category: "Protein Hewani", unit: "gram", common_quantity: 200 },
  { name: "Ikan lele", category: "protein", sub_category: "Protein Seafood", unit: "gram", common_quantity: 300 },
  { name: "Ikan gurame", category: "protein", sub_category: "Protein Seafood", unit: "gram", common_quantity: 300 },
  { name: "Ikan patin", category: "protein", sub_category: "Protein Seafood", unit: "gram", common_quantity: 300 },
  { name: "Ikan mas", category: "protein", sub_category: "Protein Seafood", unit: "gram", common_quantity: 300 },
  { name: "Salmon", category: "protein", sub_category: "Protein Seafood", unit: "gram", common_quantity: 200 },
  { name: "Tongkol", category: "protein", sub_category: "Protein Seafood", unit: "gram", common_quantity: 300 },
  { name: "Kembung", category: "protein", sub_category: "Protein Seafood", unit: "gram", common_quantity: 300 },
  { name: "Tenggiri", category: "protein", sub_category: "Protein Seafood", unit: "gram", common_quantity: 250 },
  { name: "Tuna", category: "protein", sub_category: "Protein Seafood", unit: "gram", common_quantity: 200 },
  { name: "Kakap", category: "protein", sub_category: "Protein Seafood", unit: "gram", common_quantity: 300 },
  { name: "Teri", category: "protein", sub_category: "Protein Seafood", unit: "gram", common_quantity: 100 },
  { name: "Ikan asin", category: "protein", sub_category: "Protein Seafood", unit: "gram", common_quantity: 100 },
  ...
  { name: "Lobster", category: "protein", sub_category: "Protein Seafood", unit: "gram", common_quantity: 300 },
  { name: "Cumi-cumi", category: "protein", sub_category: "Protein Seafood", unit: "gram", common_quantity: 200 },
  { name: "Sotong", category: "protein", sub_category: "Protein Seafood", unit: "gram", common_quantity: 200 },
  { name: "Gurita", category: "protein", sub_category: "Protein Seafood", unit: "gram", common_quantity: 200 },
  ...
  { name: "Oncom", category: "protein", sub_category: "Protein Nabati", unit: "gram", common_quantity: 200 },
  { name: "Kacang tanah", category: "protein", sub_category: "Protein Nabati", unit: "gram", common_quantity: 100 },
  { name: "Kacang hijau", category: "protein", sub_category: "Protein Nabati", unit: "gram", common_quantity: 100 },
  { name: "Kacang merah", category: "protein", sub_category: "Protein Nabati", unit: "gram", common_quantity: 100 },
  { name: "Kacang kedelai", category: "protein", sub_category: "Protein Nabati", unit: "gram", common_quantity: 100 },
  { name: "Edamame", category: "protein", sub_category: "Protein Nabati", unit: "gram", common_quantity: 100 },
  { name: "Jamur", category: "protein", sub_category: "Protein Nabati", unit: "gram", common_quantity: 150 },
  { name: "Wijen", category: "protein", sub_category: "Protein Nabati", unit: "gram", common_quantity: 50 },
  { name: "Beras", category: "karbo", sub_category: "Karbohidrat", unit: "gram", common_quantity: 500 },
  { name: "Kentang", category: "karbo", sub_category: "Karbohidrat", unit: "gram", common_quantity: 300 },
  { name: "Ubi", category: "karbo", sub_category: "Karbohidrat", unit: "gram", common_quantity: 250 },
  { name: "Jagung", category: "karbo", sub_category: "Karbohidrat", unit: "tongkol", common_quantity: 2 },
  { name: "Bayam", category: "sayur", sub_category: "Sayur-Mayur", unit: "ikat", common_quantity: 1 },
  { name: "Kangkung", category: "sayur", sub_category: "Sayur-Mayur", unit: "ikat", common_quantity: 1 },
  { name: "Wortel", category: "sayur", sub_category: "Sayur-Mayur", unit: "gram", common_quantity: 200 },
  { name: "Brokoli", category: "sayur", sub_category: "Sayur-Mayur", unit: "gram", common_quantity: 200 },
  { name: "Bawang Merah", category: "bumbu", sub_category: "Bumbu Dapur", unit: "siung", common_quantity: 5 },
  { name: "Bawang Putih", category: "bumbu", sub_category: "Bumbu Dapur", unit: "siung", common_quantity: 3 },
  { name: "Cabai", category: "bumbu", sub_category: "Bumbu Dapur", unit: "buah", common_quantity: 5 },
  { name: "Garam", category: "bumbu", sub_category: "Bumbu Dapur", unit: "sdt", common_quantity: 1 },
];
...
const recipes = [
  ...
  },
  {
    ...
    steps: [
      { order: 1, instruction: "Haluskan bawang putih, bawang merah, dan bumbu lainnya." },
  ...
  },
  {
    ...
    steps: [
      ...
      { order: 6, instruction: "Masukkan nasi dan garam. Aduk rata dengan api besar." },
  ...
  },
  {
    ...
    steps: [
      ...
      { order: 2, instruction: "Haluskan bawang merah, bawang putih, dan cabai." },
      { order: 3, instruction: "Tumis bumbu halus sampai harum." },
      { order: 4, instruction: "Masukkan daging, aduk rata dengan bumbu." },
      { order: 5, instruction: "Tambahkan santan, masak dengan api sedang sambil sesekali diaduk." },
  ...
  },
  {
    ...
    description: "Tahu kukus dengan bumbu rempah dalam bungkus daun pisang. Plant based friendly.",
    image_url: "",
    ingredients: [
    ...
    steps: [
      ...
      { order: 4, instruction: "Campur tahu dengan jamur, bumbu iris, dan garam." },
      { order: 5, instruction: "Bungkus dengan daun pisang, semat dengan lidi." },
      { order: 6, instruction: "Kukus selama 30 menit. Sajikan." },
    ],
    category: "Healthy & Clean",
    meal_type: ["lunch", "dinner"],
    tags: ["Healthy & Clean", "Plant Based", "Budget Friendly", "Indonesian Comfort"],
    prep_time: 15,
    cook_time: 35,
    servings: 3,
